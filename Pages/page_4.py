...
st.write(df_carteira[['codigo_ativo', 'categoria', 'aporte', 'aporte_per']].head(qt_ativo_aporte).sort_values(op_ordem[option], ascending=[False]).style.format(precision=2, thousands=".", decimal=",", subset=['aporte_per']))
