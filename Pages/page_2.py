...
with col2:
    st.button(icon=':material/cancel:', help='Desmarcar tudo', key='Key_BT_3', on_click=sl_nada_ex)
with col3:
    st.button(icon=':material/checklist_rtl:', help='Selecionar tudo', key='Key_BT_2', on_click=sl_tudo_ex)
with col4:
    op_ordem = {
