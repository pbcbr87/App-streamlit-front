...
#Delcarar sessions
#------------------------------------------------
if "ative_cookie" not in st.session_state:
    st.session_state.ative_cookie = True
    
if "deleteCookie" not in st.session_state:
...
print('deleteCookie', st.session_state.deleteCookie)
...
if st.session_state.logado == False:
    print('reste todu mundo via false')
    st.session_state.logado = False
    st.session_state.user = None
    st.session_state.id = None
    st.session_state.token = None
