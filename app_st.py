...
if st.session_state.logado == False:
    ...
    pg = st.navigation([st.Page(home,title='inicio'), st.Page('Pages/page_empty.py', title='Teste'), st.Page('Pages/page_1.py', title='Operações'), st.Page('Pages/page_2.py', title='Carteira')])            
